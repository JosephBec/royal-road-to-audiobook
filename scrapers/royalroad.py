...
Rate-limited to 1 request/second (via BaseScraper) to be polite.
"""
...
class RoyalRoadScraper(BaseScraper):
    name = "Royal Road"
    url_patterns = [re.compile(r"https?://(?:www\.)?royalroad\.com/fiction/\d+")]
    ...
    async def scrape_novel_metadata(self, url: str) -> dict:
        ...
        async with httpx.AsyncClient(timeout=30) as client:
            resp = await self._rate_limited_get(client, canonical_url)
